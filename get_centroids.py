...
print(counties_gdf['STATEFP'])
# 1.1) Leer el dataframe de estacines
stations_df = pd.read_excel('stations.xlsx')
df_yield = pd.read_csv('source_data/crop_yield.csv')
#Estados del corn belt
state_fips_to_abbr = {
    "17": "IL",
    "18": "IN",
    "19": "IA",
...
state_alpha_to_fips = {
    ...
    "WI": "55",
    "WY": "56",
    "DC": "11",   # Distrito de Columbia
    "AS": "60",   # Samoa Americana
    "GU": "66",   # Guam
    "MP": "69",   # Islas Marianas del Norte
    "PR": "72",   # Puerto Rico
