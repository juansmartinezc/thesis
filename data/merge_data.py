...
columns = ['state_name', 'county_name', 'state_alpha', 'county_code', 'month', 'year', 'stationTriplet', 'stationId','name', 'lat_centroid', 'lon_centroid', 'latitude', 'longitude', 'TMAX', 'TMIN', 'phh2o', 'ocd', 'cec','sand', 'silt', 'clay', 'PRCP', 'SMS_-2', 'SMS_-4', 'SMS_-8', 'SMS_-20', 'SMS_-40', 'TAVG', 'Value', 'unit_desc']
...
def save_monthly_climate_soil_data_by_scan_station(monthly_climate_soil_data_by_station):
    monthly_climate_soil_data_by_station.to_csv(f'{source_data_directory}/monthly_climate_soil_data_by_scan_station.csv', index=False)
