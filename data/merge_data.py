...
soil_data_by_station = pd.read_csv(f"{source_data_directory}/soil_data_by_station.csv")
...
def merge_counties_crop_yield_with_scan_stations(centroids_cornbelt_counties_crop_yield, stations_voronoi):
    crop_yield_usda_stations = centroids_cornbelt_counties_crop_yield.merge(right=stations_voronoi, on=["lat_centroid", "lon_centroid"])
    return crop_yield_usda_stations

def save_crop_yield_usda_stations(crop_yield_usda_stations):
...
def merge_counties_crop_yield_with_historical_scan_stations(crop_yield_usda_stations, monthly_climate_soil_data_by_station):
    ...
    return monthly_historical_climate_soil_data_by_station
