...
historical_monthly_climate_data_apr_sept_by_scan_stations = pd.read_csv(f'{source_data_directory}/historical_monthly_climate_data_apr_sept_by_scan_stations.csv')
...
historical_monthly_climate_soild_data_apr_sept_by_scan_stations = merge_monthly_scan_stations_with_soil(soil_data_by_scan_stations, historical_monthly_climate_data_apr_sept_by_scan_stations)
save_monthly_climate_soil_data_by_scan_station(historical_monthly_climate_soild_data_apr_sept_by_scan_stations)
'''
...
monthly_historical_climate_soil_crop_yield_data_by_scan_stations = merge_counties_crop_yield_with_historical_scan_stations(crop_yield_by_scan_stations, historical_monthly_climate_data_apr_sept_by_scan_stations)
save_counties_crop_yield_with_historical_scan_stations(monthly_historical_climate_soil_crop_yield_data_by_scan_stations)
'''
######## Check point##########
monthly_historical_climate_soil_crop_yield_data_by_scan_stations = merge_counties_crop_yield_with_historical_scan_stations(crop_yield_by_scan_stations, historical_monthly_climate_soild_data_apr_sept_by_scan_stations)
save_counties_crop_yield_with_historical_scan_stations(monthly_historical_climate_soil_crop_yield_data_by_scan_stations)
'''
